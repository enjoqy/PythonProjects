...
class CzcfangPipeline(object):

    def __init__(self):
        # 连接MySQL数据库
        self.connect = pymysql.connect(host='localhost', user='root', password="1234", db='e_house', port=3306)
    ...
    def process_item(self, item, spider):
        ...
        #       "(\"" + {} + "\",\"" + {} + "\",\"" + {} + "\",\"" + {} + "\",\"" + {} + "\",\"" + \
        #       {} + "\",\"" + {} + "\",\"" + {} + "\",\"" + {} + "\");"
        sql = "INSERT INTO agent (s_name, s_phone, s_department, s_images) " \
              " VALUES " \
              "(\"" + item['s_name'] + "\",\"" + item['s_phone'] + "\",\"" + item['s_department'] + "\",\"" + item['s_images'] + "\");"
        #
